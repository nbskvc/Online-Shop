...
public class AccountFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btHist = v.findViewById(R.id.purchase_hist_bt);
        btProfile = v.findViewById(R.id.my_profile_bt);
    ...
    public void onClick(View view) {
        switch(view.getId()){
            case(R.id.my_profile_bt):
                ...
                break;
            case(R.id.purchase_hist_bt):
               Log.d("history", "clicked!");
                Intent intent2 = new Intent(getActivity(), PurchaseHistoryActivity.class);
